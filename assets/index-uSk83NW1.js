...
#define LOW_PRECISION`),e}function $C(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Sy?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===T1?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===vr&&(e="SHADOWMAP_TYPE_VSM"),e}function YC(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ga:case Wa:e="ENVMAP_TYPE_CUBE";break;case Lc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function KC(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Wa:e="ENVMAP_MODE_REFRACTION";break}return e}function qC(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Ey:e="ENVMAP_BLENDING_MULTIPLY";break;case G1:e="ENVMAP_BLENDING_MIX";break;case W1:e="ENVMAP_BLENDING_ADD";break}return e}function ZC(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function JC(r,e,t,n){const s=r.getContext(),o=t.defines;let l=t.vertexShader,c=t.fragmentShader;const f=$C(t),d=YC(t),p=KC(t),m=qC(t),v=ZC(t),y=BC(t),E=zC(o),M=s.createProgram();let S,_,R=t.glslVersion?"#version "+t.glslVersion+`
